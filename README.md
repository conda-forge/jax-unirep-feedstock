...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jax-unirep-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15452&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jax-unirep-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jax-unirep` can be installed with:

```
conda install jax-unirep
```

It is possible to list all of the versions of `jax-unirep` available on your platform with:
